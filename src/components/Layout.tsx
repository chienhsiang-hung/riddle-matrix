...
export default function Layout() {
  ...
  return (
    // 使用 Tailwind v4 的 CSS 變數定義 Dark Mode 背景色
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-gray-950/70 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-8 items-center font-medium text-gray-700 dark:text-gray-300">
            <Link to="/puzzles" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">{t('nav.puzzles')}</Link>
            <Link to="/concepts" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">{t('nav.concepts')}</Link>
