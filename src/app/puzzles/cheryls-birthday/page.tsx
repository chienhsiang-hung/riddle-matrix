...
import { ArrowRight, RotateCcw, Lightbulb, MessageCircle, CalendarCheck } from 'lucide-react';
...
export default function CherylsBirthdayPuzzle() {
  ...
  const stepsInfo = [
    { title: t('cherylsBirthday.step0'), quote: '', explain: '', speaker: '' },
    { title: t('cherylsBirthday.step1'), quote: t('cherylsBirthday.step1Quote'), explain: t('cherylsBirthday.step1Explain'), speaker: 'Albert' },
    { title: t('cherylsBirthday.step2'), quote: t('cherylsBirthday.step2Quote'), explain: t('cherylsBirthday.step2Explain'), speaker: 'Bernard' },
    { title: t('cherylsBirthday.step3'), quote: t('cherylsBirthday.step3Quote'), explain: t('cherylsBirthday.step3Explain'), speaker: 'Albert' }
  ];
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        {/* 左側：邏輯對話控制台 */}
        <div className="lg:col-span-5 bg-white dark:bg-gray-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col h-full">
          ...
          <div className="flex-grow">
            {step > 0 ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-gray-400 dark:text-gray-600 space-y-4 py-12">
                <CalendarCheck className="w-16 h-16 opacity-20" />
                <p className="text-center font-medium">點擊下方按鈕開始邏輯推演</p>
              </div>
            )}
          </div>
          ...
          {dates.map((date) => {
            ...
            return (
              ...
              >
                ...
                `}>
                  {t(`cherylsBirthday.months.${date.month}`)}
                </div>
